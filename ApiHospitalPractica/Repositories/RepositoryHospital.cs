...
namespace ApiHospitalPractica.Repositories
{
    public class RepositoryHospital
    {
        ...
        public async Task InsertHospitalAsync(int hos_cod, string nombre, string direccion, string telefono, int num_cam)
        {
        ...
        public async Task UpdateHospital(int hos_cod, string nombre, string direccion, string telefono, int num_cam)
        {
